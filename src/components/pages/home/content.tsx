...
const anchorClassname = "text-center d-block w-100 bg-lighter p-2"
    ...
    <>
        <Row className={`${styles.row2} align-items-center`}>
            ...
            <Col md={8} className={`text ${styles.text}`}>
                ...
                <p>
                    ...
                    analyst, everyone has a role to play in the creation of a successful project.
                </p>
            </Col>
        </Row>
        <Row className={`${styles.row} align-items-center`}>
            <Col md={8} className={`text ${styles.text}`}>
                ...
                <p>
                    Need a project done? Help empower the next generation of engineers, computer
                    scientists, designers, and businesspeople acheive their goals by giving them
                    the opportunity to work on a project for you. Using our platform, you can get
                    fulfill your needs while helping students fulfill theirs.
                </p>
            </Col>
            <Col md={4}>
        ...
        <div className="my-5">
            ...
            >
                ...
                <SwiperSlide>
                    <div className="bg-lighter">
                        <a href="https://kkcabinets.ca/" target="_blank" rel="noopener noreferrer">
                            <Img
                                className={`w-100 ${styles.slideImage}`}
                                lazy
                                src={LogoKkCabinets}
