...
class EditCompetitionComponent extends BaseComponent {
    /**
    ...
    private _submit = async (
        ...
        if (!shouldSubmit) {
            ...
            const result = await editCompetitionAdapter(this.user, {
            ...
            if (!(result instanceof Error)) {
                notify({
                    ...
                    content: `Successfully ${
                        this.props.id === undefined ? "created" : "edited"
                    } your competition!`,
                    icon: "done_all",
                    iconClassName: "text-success",
                })
     ...
     */
    private _datePicker = (): JSX.Element => (
     ...
     */
    private _markdownPreview = (): JSX.Element => (
    ...
    private _markdownEditor = (): JSX.Element => (
        <Editor
